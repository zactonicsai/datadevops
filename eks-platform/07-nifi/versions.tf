...
# 07-nifi/versions.tf
# =============================================================================
# Providers for the Apache NiFi layer.
#
...
terraform {
  ...
  required_providers {
    ...
    # Used to generate the NiFi admin password so no credential is ever
...
# -----------------------------------------------------------------------------
# Read layer 06's outputs to learn the Kafka bootstrap address.
# -----------------------------------------------------------------------------
# This also enforces ordering: NiFi cannot be planned until Kafka exists.
