# =============================================================================
# 05-strimzi-operator/versions.tf
# =============================================================================
# Providers for the Strimzi Kafka operator layer.
#
...
terraform {
  ...
  required_providers {
    ...
    # The time provider gives us time_sleep, used at the end of main.tf to
    # let the Strimzi CRDs finish registering with the API server before the
    # next layer tries to plan against them.
    time = {
