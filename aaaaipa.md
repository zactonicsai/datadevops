...
4. [Checking Status: Every Verification Command You Need](#4-checking-status-every-verification-command-you-need)
5. [The Big List: 25 Ways IPA Fails and How to Fix Each One](#5-the-big-list-25-ways-ipa-fails-and-how-to-fix-each-one)
6. [Automating Recovery: Scripts That Fix Things While You Sleep](#6-automating-recovery-scripts-that-fix-things-while-you-sleep)
7. [Monitoring: Knowing Before Your Users Do](#7-monitoring-knowing-before-your-users-do)
8. [Backup and Disaster Recovery](#8-backup-and-disaster-recovery)
9. [Alternatives: Is Something Else More Reliable?](#9-alternatives-is-something-else-more-reliable)
...
## 4. Checking Status: Every Verification Command You Need
...
## 5. The Big List: 25 Ways IPA Fails and How to Fix Each One
...
## 6. Automating Recovery: Scripts That Fix Things While You Sleep
...
## 7. Monitoring: Knowing Before Your Users Do
...
sudo ipa-replica-manage clean-ruv <ID>     # if RUV lingers
...
## 9. Alternatives: Is Something Else More Reliable?
