...
You have three common ways to create the cluster. Pick **one**. We show all three so your team can use whichever fits your workflow. `eksctl` is fastest to learn; Terraform is best for real infrastructure-as-code; the raw AWS CLI is shown so you understand what's happening underneath.
